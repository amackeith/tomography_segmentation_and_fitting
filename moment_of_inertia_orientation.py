		...
		for j in range(shp[1]):
			for k in range(shp[2]):
				if arr[i,j,k]==1:
					...
					moment_of_inertia[0,0] = moment_of_inertia[0,0]+y**2+z**2	#I_xx
					moment_of_inertia[1,1] = moment_of_inertia[1,1]+x**2+z**2	#I_yy
					moment_of_inertia[2,2] = moment_of_inertia[2,2]+x**2+y**2 #I_zz
					moment_of_inertia[0,1] = moment_of_inertia[0,1]-x*y #I_xy
					moment_of_inertia[1,2] = moment_of_inertia[1,2]-y*z	#I_yz
					moment_of_inertia[0,2] = moment_of_inertia[0,2]-x*z	#I_xz
