...
def make_lattice(que):
    a, a_la = grid_lattice()
    np.save('../old_py/grid_lattice.npy', a)
    np.save('../old_py/grid_lattice_la.npy', a_la)
...
def make_lattice_random_orientations(que):
    ...
    np.save('../old_py/grid_lattice_random_orientations.npy', b)
    np.save('../old_py/grid_lattice_random_orientations_la.npy', b_la)
...
def make_random(que):
    c, c_la = grid_random()
    np.save('../old_py/grid_random.npy', c)
    np.save('../old_py/grid_random_la.npy', c_la)
