...
if False:
	...
	if os.path.exists("%s_de_noised_de_ringed.npy" % fname):
		...
		print("python label_watershed_method.py %s_de_noised_de_ringed.npy %s %s %s %s %s" % (
		fname, threshold_of_binary, threshold_of_eroded_binary, gauss_filt_sigma, threshold_of_edm2,
		min_vol_for_segment))
		os.system("python label_watershed_method.py %s_de_noised_de_ringed.npy %s %s %s %s %s" % (
		fname, threshold_of_binary, threshold_of_eroded_binary, gauss_filt_sigma, threshold_of_edm2,
		min_vol_for_segment))
	else:
